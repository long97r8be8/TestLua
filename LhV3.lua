...
local FruitTab = sitinkgui:MakeTab("Fruit")
local RaidTab = sitinkgui:MakeTab("Raid")
local RaceTab = sitinkgui:MakeTab("Race")
local ShopTab = sitinkgui:MakeTab("Shop")
local MiscTab = sitinkgui:MakeTab("Misc")
local HopTab = sitinkgui:MakeTab("Hop")
...
local Section = DiscordTab:Section({
    ["Title"] = "Discord Me",
    ["Content"] = "Copy Link Discord"
})
local Seperator = Section:Seperator("Discord Me")
...
local Button1 = Section:Button({
    ...
    Callback = function()
        setclipboard("https://discord.com/invite/7ktB8D87")
    end
})
...
local Seperator = Section:Seperator("Farm Main")
local Paragraph = Section:Paragraph({
    ["Title"] = "Fast Attack",
