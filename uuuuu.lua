...
local PlayerTab = sitinkgui:MakeTab("Player")
local IslandTab = sitinkgui:MakeTab("Island")
local FruitsTab = sitinkgui:MakeTab("Fruits")
local RaidTab = sitinkgui:MakeTab("Raid")
local VisualTab = sitinkgui:MakeTab("Visual")
local Status SeverTab = sitinkgui:MakeTab("Status Sever")
local RaceV4Tab = sitinkgui:MakeTab("RaceV4")
local ShopTab = sitinkgui:MakeTab("Shop")
local MiscTab = sitinkgui:MakeTab("Misc")
local SettingTab = sitinkgui:MakeTab("Setting")
end
...
local Seperator = Section:Seperator("FarmMain")
local Paragraph = Section:Paragraph({
    ["Title"] = "Selected Vũ Khí",
    ["Content"] = ""
})
local DropdownSelectWeapon = Section:Dropdown("DropdownSelectWeapon", {
    Title = "Weapon",
    Multi = false,
    Options = {"Melee", "Sword", "Blox Fruit"},
    Default = 1
})
    DropdownSelectWeapon:SetOptions("Melee")
